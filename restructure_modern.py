...
document.addEventListener('DOMContentLoaded', function() {
  ...
  aiPromptHeadings.forEach(heading => {
    ...
    // Search for the pre/code block (might be after a <p> tag)
    while (nextElement && !codeBlock) {
      if (nextElement.tagName === 'PRE') {
        codeBlock = nextElement;
        break;
      }
    ...
    // Get the prompt text from the code block
    ...
    chatgptBtn.href = `https://chat.openai.com/?q=${encodedPrompt}`;
    chatgptBtn.target = '_blank';
    chatgptBtn.className = 'ai-quick-btn chatgpt-btn';
    chatgptBtn.title = 'Open in ChatGPT';
    chatgptBtn.innerHTML = `<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
    ...
    claudeBtn.href = `https://claude.ai/new?q=${encodedPrompt}`;
    claudeBtn.target = '_blank';
    claudeBtn.className = 'ai-quick-btn claude-btn';
    claudeBtn.title = 'Open in Claude';
    claudeBtn.innerHTML = `<svg fill="currentColor" height="14" viewbox="0 0 24 24" width="14">
    ...
    googleBtn.href = `https://www.google.com/search?q=${encodedPrompt}`;
    googleBtn.target = '_blank';
    googleBtn.className = 'ai-quick-btn google-btn';
    googleBtn.title = 'Search in Google';
    googleBtn.innerHTML = `<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
